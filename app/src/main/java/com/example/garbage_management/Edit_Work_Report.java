...
public class Edit_Work_Report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (work.isEmpty()){
                    Toast.makeText(Edit_Work_Report.this, "No any work", Toast.LENGTH_SHORT).show();
                    edit_date.setText(null);
                }else{
                    Toast.makeText(Edit_Work_Report.this, "Work Found! User:"+work.get(0).toString(), Toast.LENGTH_SHORT).show();
        ...
        editbin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(status){
                    Toast.makeText(Edit_Work_Report.this, "Work Updated !", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(Edit_Work_Report.this, "Work Failed !", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        deletebin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Edit_Work_Report.this, "User Delete !", Toast.LENGTH_SHORT).show();
            }
        });
